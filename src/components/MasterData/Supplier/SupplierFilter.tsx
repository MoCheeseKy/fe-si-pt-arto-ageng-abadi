// src/components/MasterData/Supplier/SupplierFilter.tsx
...
/** * State filter sekunder untuk pencarian data Supplier.
 * (Field company_name dipisahkan untuk global search input)
 */
...
interface SupplierFilterProps {
  filterInput: SupplierFilterState;
  setFilterInput: React.Dispatch<React.SetStateAction<SupplierFilterState>>;
...
/**
 * Merender UI Popover yang berisi input form untuk memfilter tabel Supplier.
 * * @param {SupplierFilterProps} props - Handler dan state yang mengontrol Popover dan Filter
 */
