// src/components/Operasional/Kontrak/Offer/OfferFilter.tsx
  ...
  return (
    <Popover open={isFilterOpen} onOpenChange={setIsFilterOpen}>
      ...
      <PopoverContent
        ...
        align='end'
        // Mencegah popover filter tertutup saat mengklik kalender (class rdp dari react-day-picker)
        onInteractOutside={(e) => {
      ...
      >
        <div className='space-y-4'>
          ...
          <div className='space-y-4'>
            ...
            />
            {/* PERBAIKAN: Gunakan functional update (prev) */}
            <DatePicker
