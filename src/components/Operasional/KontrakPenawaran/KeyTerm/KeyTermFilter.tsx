// src/components/Operasional/Kontrak/KeyTerm/KeyTermFilter.tsx
      ...
      >
        <div className='space-y-4'>
          ...
          <div className='space-y-4'>
            ...
            />
            {/* PERBAIKAN: Gunakan functional update (prev) dan key 'offer_date' */}
            <DatePicker
              label='Tanggal Penawaran Referensi'
              value={filterInput.offer_date || ''}
              onChange={(val) =>
                setFilterInput((prev: any) => ({ ...prev, offer_date: val }))
              }
            />
          </div>
