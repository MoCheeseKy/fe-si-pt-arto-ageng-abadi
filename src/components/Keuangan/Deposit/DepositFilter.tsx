// src/components/Keuangan/Deposit/DepositFilter.tsx
...
interface DepositFilterProps {
  filterInput: DepositFilterState;
  setFilterInput: React.Dispatch<React.SetStateAction<DepositFilterState>>;
