// src/components/Keuangan/Payroll/PayrollFilter.tsx
...
interface PayrollFilterProps {
  filterInput: PayrollFilterState;
  setFilterInput: React.Dispatch<React.SetStateAction<PayrollFilterState>>;
        ...
        <div className='space-y-4'>
          ...
          <div className='space-y-3'>
            ...
            <Input
              ...
              onChange={(e) =>
                setFilterInput((prev) => ({ ...prev, period: e.target.value }))
              }
            />
          </div>
